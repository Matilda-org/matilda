...
class ToolsController < ApplicationController
  ...
  # Crew: instructions + install command for the local matilda-crew package.
  # Manifest is generated by `rake crew:pack`; the page degrades gracefully without it.
  def crew
    manifest_path = Rails.public_path.join("crew", "manifest.json")
    @crew_manifest = File.exist?(manifest_path) ? JSON.parse(File.read(manifest_path)) : nil
  end
